...
/// Exemplo de implementação do State. Note que as implementações concretas da
/// trait State recebem como parâmetro uma referência ao player instanciado.
/// Bem como sempre retorna alguma implementação da trait State, desta maneira
/// os estados ficam se alternando. Expressando assim também um comportamento
/// único por estado.
